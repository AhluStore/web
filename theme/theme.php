...
<!-- Mirrored from ocean.tonytemplates.com/viktor/your_store_demo/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Nov 2017 12:00:20 GMT -->
<head>
      <!-- Basic -->
            ...
            <ul class="expander-list">          
               <li>
                  <span class="name">
                     ...
                     <a href="/"><span class="act-underline">Home</span></a>
                  </span>
               </li>             
               <li>
                  <span class="name">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-sm-4 col-md-4 col-lg-6 col-xl-7">
                     <!-- logo start --> 
                     <a href="<?php echo site_url(); ?>"><img class="logo replace-2x img-responsive" src="images/logo.png" alt=""/> </a> 
                     <!-- logo end --> 
                  </div>
                           ...
                           <div class="responsive-menu mainMenu">                         
                              ...
                              <ul class="nav navbar-nav">
                                 ...
                                 <li class="dropdown dropdown-mega-menu">                                
                                    <a href="<?php echo site_url(); ?>" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">Home</span></a>

                                 </li>                               
                                 <li class="dropdown dropdown-mega-menu">
                                    <span class="dropdown-toggle extra-arrow"></span>
                                    <a href="<?php echo site_url("flash-sale"); ?>" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">Sản phẩm Sale</span></a>
                                 </li>
                                 <li class="dropdown dropdown-mega-menu">
                                    <span class="dropdown-toggle extra-arrow"></span>
                                    <a href="<?php echo site_url("flash-sale"); ?>" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">Sản phẩm mua lại</span></a>
                                 </li>
                                 <li class="dropdown dropdown-mega-menu">
                                    <span class="dropdown-toggle extra-arrow"></span>
                                 ...
                                 <li class="dropdown dropdown-mega-menu">
                                    <span class="dropdown-toggle extra-arrow"></span>
                                    <a href="<?php echo site_url("affiliate") ?>" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">Cộng tác viên</span></a>
                                 </li>
                                  <li class="dropdown dropdown-mega-menu">
                                    <span class="dropdown-toggle extra-arrow"></span>
                                    <a href="<?php echo site_url("contact") ?>" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">Liên hệ</span></a>
                                 </li>
                              </ul>
                           </div>
                        </nav>
                        ...
                        <div class="text-right">   
                           ...
                           <div class="account link-inline">
                              <div class="dropdown text-right">
                                 ...
                                 <ul class="dropdown-menu dropdown-menu--xs-full">
                                    <li><a href="<?php echo ahlu_e_shop_user(); ?>"><span class="icon icon-person"></span>My Account</a></li>
                                    <li><a href="<?php echo ahlu_e_shop_user("wishlist"); ?>"><span class="icon icon-favorite_border"></span>My Wishlist</a></li>
                                    <li><a href="<?php echo ahlu_e_shop_user("compare"); ?>"><span class="icon icon-sort"></span>Compare</a></li>
                                    <li><a href="<?php echo ahlu_e_cart(); ?>"><span class="icon icon-done_all"></span>Cart</a></li>
            ...
            <div class="row" >
               <div class="col-sm-12 col-md-5 col-lg-6 border-sep-right">
                  <div class="footer-logo hidden-xs">
                     <!--  Logo  --> 
                     <a class="logo" href="<?php echo site_url(); ?>"> <img class="replace-2x" src="images/logo.png"  alt="AhluStore"> </a> 
                     <!-- /Logo --> 
                  </div>
                  <div class="box-about">
                     <div class="mobile-collapse">
                        ...
                        <div class="mobile-collapse__content">
                           <p> No more need to look for other ecommerce themes. We provide huge number of different layouts. AhluStore comes packed with free and useful features developed to make your website creation easier. Innovative clean design, advanced functionality, UI made for humans, extensive documenta- tion and support i continue this list infinitely... </p>
                        </div>
                     </div>
                  </div>
                 [AhluCouponInline]
                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-4">
                        <div class="mobile-collapse">
                           ...
                           <div class="v-links-list mobile-collapse__content">
                              <ul>
                                 <li><a href="warranty.html">Chính sách và quy định chung</a></li>
                                 <li><a href="typography.html">Quy định và hình thức thanh toán</a></li>
                                 ...
                                 <li><a href="support-24.html">Chính Sách Bảo Mật</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
    ...
    <link rel="stylesheet" href="http://cdn.rawgit.com/tabalinas/jssocials/v1.4.0/dist/jssocials-theme-flat.css">
      ...
      <script>
         $(document).ready(function() {
            ...
            productCarousel($('#carouselNew'),2,2,3,2,1);
            ...
            blogCarousel($('.slider-blog'),1,1,1,1,1);
